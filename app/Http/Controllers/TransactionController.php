    ...
    public function store(Request $request)
{
    ...
    if ($dataKamar->count() < $jumlahPesanan) {
        return redirect()->back()->with('error', 'Jumlah kamar tersedia tidak mencukupi.');
    }
    ...
    // ✅ Tambahkan kolom 'status' agar tidak error
    $transaction = Transaction::create([
        ...
        'status' => 'waiting for payment', // ✅ WAJIB ditambahkan
    ]);
    ...
    'price' => $totalHarga,
    'bukti' => '', // ✅ isi kosong dulu atau 'belum upload'
]);
    ...
    public function transactionPay(Request $request, $id)
    {
        ...
        if ($request->pay_type == "dana") {
            $pay->url = 'https://gopay.co.id/app/scanqr?deeplink_source=request_money';
            $pay->type = 'Dana';
            $pay->nomor = '0895322389911';
            ...
            $pay->type = 'Gopay';
            $pay->nomor = '089501157954';
        }else if ($request->pay_type == "ShopeePay") {
            $pay->url = 'https://app.u.shopeepay.co.id/u/v17rGa8MjEER4V4yfbMTV';
            $pay->type = 'ShopeePay';
            $pay->nomor = '0895322389911';
